...
Module['FS_createPath']("/Assets", "Sounds", true, true);
    ...
    loadPackage({"files": [{"filename": "/Assets/Fonts/NES_Font.ttf", "start": 0, "end": 17016}, {"filename": "/Assets/Sounds/BubbleBobble_BallLost.ogg", "start": 17016, "end": 24393, "audio": 1}, {"filename": "/Assets/Sounds/BubbleBobble_Startup.ogg", "start": 24393, "end": 43137, "audio": 1}, {"filename": "/Assets/Sounds/Custom_BrickBreak.ogg", "start": 43137, "end": 51191, "audio": 1}, {"filename": "/Assets/Sounds/Custom_PaddleHit.ogg", "start": 51191, "end": 57074, "audio": 1}, {"filename": "/Assets/Sounds/Kenney_ButtonPress.ogg", "start": 57074, "end": 61730, "audio": 1}, {"filename": "/Assets/Sounds/Kenney_ButtonRelease.ogg", "start": 61730, "end": 66610, "audio": 1}, {"filename": "/Assets/Sounds/Tetris_ButtonHover.ogg", "start": 66610, "end": 71631, "audio": 1}, {"filename": "/Assets/Sounds/Tetris_GameLost.ogg", "start": 71631, "end": 85455, "audio": 1}, {"filename": "/Assets/Sounds/Tetris_GameStart.ogg", "start": 85455, "end": 96756, "audio": 1}, {"filename": "/Assets/Sounds/Tetris_GameWon.ogg", "start": 96756, "end": 127662, "audio": 1}, {"filename": "/Assets/Sounds/Tetris_WallHit.ogg", "start": 127662, "end": 135611, "audio": 1}], "remote_package_size": 135611});

  })();

// end include: /tmp/tmp716li_1_.js
// include: /tmp/tmpkoyfrzmd.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if (Module['$ww'] || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: /tmp/tmpkoyfrzmd.js
// include: /tmp/tmpd_9x10z5.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: /tmp/tmpd_9x10z5.js
...
var ASM_CONSTS = {
 ...
 644708: ($0) => { if (Module['canvas']) { Module['canvas'].style['cursor'] = UTF8ToString($0); } },  
 644791: () => { if (Module['canvas']) { Module['canvas'].style['cursor'] = 'none'; } },  
 644860: () => { return window.innerWidth; },  
 644890: () => { return window.innerHeight; }
};
